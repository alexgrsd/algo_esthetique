...
Pour la partie projet libre, nous avons choisi de faire un système de création d'un automate basé sur la musique. Celui-ci est réalisé en java, avec la librairie sound de processing, ainsi que la librairie soundCipher trouvable [sur ce lien](https://explodingart.com/soundcipher/download.html) 
